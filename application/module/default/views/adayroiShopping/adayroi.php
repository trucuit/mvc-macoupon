...
// $a=new MuasamModel();
// $arr=$a->dataLazada();
$data_edit=$this->arrAdayroi;
$data_edit1=$this->arrAdayroi1;
...
<div class="container wrap-coupon ">
	...
	<?php for($i=0;$i<count($data_edit);$i++){
		$pos=mb_strpos($data_edit[$i]["content"]," ",20);
		?>
			...
			<!-- <a href="<?php echo $data[$i]["aff_link"];?>"> -->
				<div class="card card-height ">
					<div class="card-block khung_khuyenmai">
						...
						<img src="public/template/default/main/images/Adayroi.png" alt="" class="image_lazada">
					...
					<div class="get_coupon" id_get="<?php echo $i;?>" onclick="pupUp(<?php echo "'".URL::createLink('default','shopping','ajaxAdayroi')."'"?>,<?php echo $i;?>)">Lấy Coupon</div>
				</div>
				<!-- </a> -->
			</div>
			<?php
		...
		for($i=0;$i<count($data_edit1);$i++){
			$vt=mb_strpos($data_edit1[$i]["content"]," ",20);
			?>
		...
		<div class="modal_lazada" id="mymodal">
			...
			<div class="show_coupon">
				...
				<img src="public/template/default/main/images/Adayroi.png" alt="" class="image_show_lazada">
				<div class="copy_coupon"></div>

				<div><a class="btn_golazada" target="_blank" href="">Đến Adayroi để sử dụng mã coupon</a></div>
			</div>
